...
# from model_loaders import vit_base_patch16_224


# class PertubationEval:
#     def __init__(self):
...
# #         perturbation_steps = [0.02, 0.04, 0.06, 0.08, 0.1, 0.12, 0.14, 0.16, 0.18]
#     elif args.scale == '100':
#         base_size = 100
...
#     x = [0] + perturbation_steps + [1]
#     y = [np.mean(num_correct_model)] + np.mean(num_correct_pertub, axis=1).tolist() + [0]
...
#                         choices=['rollout', 'lrp', 'partial_lrp', 'transformer_attribution', 
#                                  'attn_last_layer', 'attn_gradcam', 'generic_attribution', 'ours', 'ours_c', 'test'],
#                         help='')
...
#                                                                                     args.vis_class, ablation_fold, args.steps))
...
#     if args.vis_class == 'index':
#         vis_method_dir = os.path.join(PATH,'visualizations/{}/{}_{}_{}'.format(args.method,
#                                                           args.vis_class,
#                                                           args.class_id, args.steps))
#     else:
#         ablation_fold = 'ablation' if args.is_ablation else 'not_ablation'
